...
export async function POST(request) {
    ...
    const { category, type, page } = body;

    const rankRes = await fetch(`https://raw.githubusercontent.com/hkgkhanh/vn-wca-db/refs/heads/main/api/rank/sor/${category}_${type}-page-${page}.json`, {
        method: "GET",
    });
