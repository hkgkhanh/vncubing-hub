            ...
            <div className='comp-page-container'>
                <div className='comp-page-nav'>
                    <div className='comp-page-nav-list'>
                        <a href={`/competitions/vnca/${slug}`} className='unactive'>
                        ...
                        <a href={`/competitions/vnca/${slug}/register`} className='unactive'>
                        ...
                        <a href={`/competitions/vnca/${slug}/registrations`} className='active' onClick={(e) => e.preventDefault()}>
