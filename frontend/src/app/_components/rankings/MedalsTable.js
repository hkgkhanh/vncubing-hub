...
export default function MedalsTable({ data, loadingStatus }) {
                    ...
                    <tbody>
                        {data.map((item, index) => (
                            <tr key={index}>
                                ...
                                <td>{item.personMedals.gold}</td>
                                <td>{item.personMedals.silver}</td>
                                <td>{item.personMedals.bronze}</td>
                                <td>{item.personMedals.gold + item.personMedals.silver + item.personMedals.bronze}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
